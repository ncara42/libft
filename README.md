...
**Estudiante:** ncaravac  
**Campus:** 42 Barcelona, España (Actualmente en 42 Madrid: 15-01-2026)  
...
Este repositorio documenta el trabajo realizado durante las series C (C00-C08), demostrando progresión desde conceptos fundamentales hasta estructuras de datos complejas y gestión de memoria dinámica. En total hay 14 proyectos (C00-C13). Pude completar los primeros 9.
...
✅ Número #1 en mi piscina por +70 correcciones peer-to-peer  
